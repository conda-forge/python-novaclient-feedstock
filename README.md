...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/python-novaclient-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=8283&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/python-novaclient-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `python-novaclient` can be installed with:

```
conda install python-novaclient
```

It is possible to list all of the versions of `python-novaclient` available on your platform with:
