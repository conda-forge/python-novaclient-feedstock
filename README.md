...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/python-novaclient-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/python-novaclient-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add python-novaclient
# for installing globally
pixi global install python-novaclient
```
...
It is possible to list all of the versions of `python-novaclient` available on your platform:
...
```
pixi search python-novaclient --channel conda-forge
```
